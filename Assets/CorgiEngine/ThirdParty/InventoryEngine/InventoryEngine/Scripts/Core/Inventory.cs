...
{	
	...
	public class Inventory : MonoBehaviour, MMEventListener<MMInventoryEvent>, MMEventListener<MMGameEvent>
	{
		...
		[Header("Persistency")]
		[Information("Here you can define whether or not this inventory should respond to Load and Save events. If you don't want to have your inventory saved to disk, set this to false.",InformationAttribute.InformationType.Info,false)]
		...
		public virtual void LoadSavedInventory()
		{
			...
			MMEventManager.TriggerEvent (new MMInventoryEvent (MMInventoryEventType.InventoryLoaded, null, this.name, null, 0, 0));
		}
