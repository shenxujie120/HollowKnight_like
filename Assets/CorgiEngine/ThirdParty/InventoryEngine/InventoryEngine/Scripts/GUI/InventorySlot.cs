	...
	public class InventorySlot : Button 
	{
		...
		public override void OnSelect(BaseEventData eventData)
		{
			...
			if (ParentInventoryDisplay!=null)
			{
				...
				MMEventManager.TriggerEvent (new MMInventoryEvent (MMInventoryEventType.Select, this, ParentInventoryDisplay.TargetInventoryName, item, 0, Index));
			}
		}
		...
		public virtual void SlotClicked () 
		{
			...
			{
				InventoryItem item = ParentInventoryDisplay.TargetInventory.Content[Index];
				MMEventManager.TriggerEvent (new MMInventoryEvent (MMInventoryEventType.Click, this, ParentInventoryDisplay.TargetInventoryName, item, 0, Index));
		...
		public virtual void Move()
		{
			...
			else
			{
				...
				else
				{
					...
					MMEventManager.TriggerEvent (new MMInventoryEvent (MMInventoryEventType.Move, this, ParentInventoryDisplay.TargetInventoryName, ParentInventoryDisplay.TargetInventory.Content[Index], 0, Index));
				}
			}
		}
		...
		{
			if (!SlotEnabled) { return; }
			MMEventManager.TriggerEvent (new MMInventoryEvent (MMInventoryEventType.UseRequest, this, ParentInventoryDisplay.TargetInventoryName, ParentInventoryDisplay.TargetInventory.Content[Index], 0, Index));
		}
		...
		{
			if (!SlotEnabled) { return; }
			MMEventManager.TriggerEvent (new MMInventoryEvent (MMInventoryEventType.EquipRequest, this, ParentInventoryDisplay.TargetInventoryName, ParentInventoryDisplay.TargetInventory.Content[Index], 0, Index));
		}
		...
		{
			if (!SlotEnabled) { return; }
			MMEventManager.TriggerEvent (new MMInventoryEvent (MMInventoryEventType.UnEquipRequest, this, ParentInventoryDisplay.TargetInventoryName, ParentInventoryDisplay.TargetInventory.Content[Index], 0, Index));
		}
